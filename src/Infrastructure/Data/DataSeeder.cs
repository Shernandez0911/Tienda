            ...
            try
            {
                ...
                if (!await context.Users.AnyAsync())
                {
                    ...
                    User adminUser = new User
                    {
                        ...
                        Birthday = DateTime.Parse(configuration["User:AdminUser:BirthDate"] ?? throw new InvalidOperationException("La fecha de nacimiento del usuario administrador no está configurada.")),
